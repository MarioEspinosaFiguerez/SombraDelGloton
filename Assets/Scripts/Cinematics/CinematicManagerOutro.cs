...
public class CinematicManagerOutro : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        tailImage.color = new Color(tailImage.color.r, tailImage.color.g, tailImage.color.b, 0f);
    ...
    IEnumerator IntroSequence()
    {
        ...
        yield return StartCoroutine(TypeText(introTexts[0], 0.075f));            //Lejos
        yield return StartCoroutine(MoveImageLeft(introImages[0], 1.5f));
        yield return new WaitForSeconds(0.5f);

        yield return StartCoroutine(TypeText(introTexts[1], 0.075f));            //Cerca
        yield return StartCoroutine(MoveImageLeft(introImages[1], 1.5f));
        yield return new WaitForSeconds(0.5f);

        yield return StartCoroutine(TypeText(introTexts[2], 0.075f));            //Salto
        yield return StartCoroutine(MoveImageLeft(introImages[2], 1.5f));
        yield return new WaitForSeconds(0.5f);

        yield return StartCoroutine(TypeText(introTexts[3], 0.075f));            //Caida
        yield return StartCoroutine(MoveImageLeft(introImages[3], 1.5f));
        yield return new WaitForSeconds(0.5f);

        yield return StartCoroutine(TypeText(introTexts[4], 0.075f));            //Suelo
        yield return StartCoroutine(MoveImageLeft(introImages[4], 1.5f));
        yield return new WaitForSeconds(0.5f);

        yield return StartCoroutine(TypeText(introTexts[5], 0.075f));            //Irse
        yield return StartCoroutine(MoveImageLeft(introImages[5], 1.5f));
        yield return new WaitForSeconds(0.5f);

        yield return StartCoroutine(TypeText(introTexts[6], 0.075f));            //Templo
        //yield return StartCoroutine(MoveImageLeft(introImages[6], 0.5f));
        yield return new WaitForSeconds(0.5f);
        yield return StartCoroutine(TypeText(introTexts[7], 0.075f));
        yield return new WaitForSeconds(0.5f);
        yield return StartCoroutine(TypeText(introTexts[8], 0.075f));

        StartCoroutine(FadeIn(tailImage, 3f));
        ...
        StartCoroutine(FadeIn(blackPanel, 3f));
